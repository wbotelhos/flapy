  ...
  var methods = {
    init: function(settings) {
      return this.each(function() {
        ...
        methods._activeView.call(this, this.activedIndex);
    ...
    }, _activeView: function(index) {
      if (this.opt.border) {
        methods._activeTab.call(this, index);
      }

      methods._activeBox.call(this, index);
    }, _bindTabs: function() {
      var that = this;
      ...
      that.tabs.on('click', function(evt) {
        ...
        methods._activeView.call(that, index);
      });
